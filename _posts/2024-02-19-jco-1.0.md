...
toolchain built for WASI 0.1. This work predates Wasm Components, but Component
...
is newer and not yet considered stable.
...
WASI support and JavaScript Component needs. The command `jco componentize` uses
ComponentizeJS under the covers, so as jco matures you shouldn't have to think
about ComponentizeJS much, if at all.
