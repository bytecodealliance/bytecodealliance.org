...
- GC Features: Garbage collection features for the interpreter, LLVM-JIT, and AOT have been finalized.
...
- WASI Support: Ongoing support for WASI on ESP-IDF and Zephyr.
- Table64: Table64 support for the interpreter and AOT has been finalized.
